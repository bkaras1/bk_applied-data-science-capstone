...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        total = site_df['class'].count()
        success_rate = site_df['class'].sum() / total
        fig = px.pie(site_df,
...
# 3. Which payload range(s) has the highest launch success rate? 3-4k
# 4. Which F9 Booster version (v1.0, v1.1, FT, B4, B5) has the highest launch success rate? B4
